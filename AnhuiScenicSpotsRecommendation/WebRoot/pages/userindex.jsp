		...
		<div class="body-content" style="min-height: 1000px;">
			...
			<div class="wrapper">
				...
				<div class="row">
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading"> 修改用户个人信息 </header>
							<div class="panel-body">
								<div class=" form">
									<form class="cmxform form-horizontal tasi-form"
										action="userupdategerenxinxiact.action" method="post"
										...
										<div class="form-group">
											...
											<div class="controls">
												...
												<input value="${sessionScope.userinfo.name}" name="name"
													class="form-control">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="controls">
												...
												<input value="${sessionScope.userinfo.sex}" name="sex"
													class="form-control">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="controls">
												...
												<input value="${sessionScope.userinfo.age}" name="age"
													class="form-control">
											</div>
										</div>
										<div class="form-group">
											...
											<textarea name="introduce" style="height: 200px;"
												class="form-control">${sessionScope.userinfo.introduce}</textarea>
										</div>
										<div class="form-group">
