		...
		<div class="body-content" style="min-height: 1000px;">
			...
			<div class="wrapper">
				...
				<div class="row">
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading"> 添加收藏 </header>
							<div class="panel-body">
								<div class=" form">
									<form class="cmxform form-horizontal tasi-form"
										action="addhistoryact.action" method="post"
										...
										<div class="form-group">
											...
											<div class="controls">
												...
												<input name="scenicspot" class="form-control">
											</div>
										</div>
										...
										<div style='display: none;' class="form-group">
											...
											<div style='display: none;' class="controls">
												...
												<input name="scenicspotid" class="form-control">
											</div>
										</div>
										<div class="form-group">
											<label for="">用户</label>
			...
			<footer> 2022 &copy; wirte by PingAn. </footer>
			<!--footer section end-->
		</div>
		<!-- body content end-->
	</section>
