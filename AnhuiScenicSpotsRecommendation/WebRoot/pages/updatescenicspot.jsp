		...
		<div class="body-content" style="min-height: 1000px;">
			...
			<div class="wrapper">
				...
				<div class="row">
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading"> 修改景点 </header>
							<div class="panel-body">
								<div class=" form">
									<form class="cmxform form-horizontal tasi-form"
										action="updatescenicspotact.action" method="post"
										...
										<div class="form-group">
											<label for="">名称</label>
											<div class="controls">
												<!-- 定义名称input输入框，并从request中取值scenicspot.name赋值  -->

												<input name="name" value="${scenicspot.name}"
													class="form-control">
											</div>
										</div>
										<div class="form-group" style="display: none;">
											<label for="">图片</label>
											<div class="controls">
												<!-- 定义图片input输入框，并从request中取值scenicspot.pic赋值  -->

												<input name="pic" value="${scenicspot.pic}"
													class="form-control">
											</div>
										</div>
										<div class="form-group">
											...
											<textarea name="introduce" style="height: 200px;"
												class="form-control">${scenicspot.introduce}</textarea>
										</div>
										<div class="form-group">
											<label for="">原文地址</label>
											<div class="controls">
												<!-- 定义原文地址input输入框，并从request中取值scenicspot.orgurl赋值  -->

												<input name="orgurl" value="${scenicspot.orgurl}"
													class="form-control">
											</div>
										</div>
										<div class="form-group">
