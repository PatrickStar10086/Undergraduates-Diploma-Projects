...
<body class="login-body">
	...
	<div class="container log-row">
		<form class="form-signin" action="loginact.action" method="post">
			<div class="login-wrap">
				<input type="text" class="form-control" name="username"
					placeholder="请输入用户名" required autofocus> <input
					type="password" class="form-control" name="password"
					placeholder="请输入密码" required> <select type="password"
					class="form-control" name="identity"><option>管理员</option>
					<option>用户</option></select>
				<button qw-c="operationbutton"
					class="btn btn-lg btn-success btn-block" type="submit"
					style="margin-top: 15px;">登录</button>
