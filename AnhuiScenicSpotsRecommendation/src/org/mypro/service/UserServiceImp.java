...
public interface UserServiceImp {
	...
	public void adduseract(HttpServletRequest request, HttpSession session, User user) throws IOException; // 定义adduseractjson接口
	...
	public void updateuseract(HttpServletRequest request, User user, HttpSession session) throws IOException; // 定义updateuseractjson处理用户修改
